<x-guest-layout>
    ...
    <form method="POST" action="{{ route('login') }}" class="max-w-md mx-auto p-10 bg-white ">
        ...
        <div style="margin-bottom: 16px">
            <x-input-label for="email" :value="__('Email')" style="font-weight: bold; margin-bottom: 8px; font-size: 16px;"/>
        ...
        <div class="mt-4" style="margin-bottom: 16px">
            <x-input-label for="password" :value="__('Password')" style="font-weight: bold; margin-bottom: 8px; font-size: 16px;"/>
