<x-app-layout>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 p-6 bg-gray-100">
        @foreach ($finalCountCss as $finalCoun)
        <a class="block bg-white shadow-lg rounded-lg overflow-hidden transform transition hover:scale-105 hover:shadow-xl">
            <div class="p-6">
                <h2 class="font-bold text-xl mb-2 text-gray-700">Question:</h2>
