<x-app-layout>
    <div style="min-height: 100vh; width: 100%; background-color: #3AAFA9; padding-top: 12px;">
        <div style="max-width: 1280px; margin: 0 auto; padding-left: 24px; padding-right: 24px; min-height: 100%;">
