<x-app-layout>
    ...
    <section class="text-center py-10" style="background-color: #3AAFA9;">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 justify-items-center">
            ...
            <!-- HTML Progress -->
            <a href="course/course/HtmlPrograss">
                <div style="position: absolute ; left: 10vw; top: 40vh" class="flex items-center space-x-4 mt-8 " >
                    ...
                    <div >
                        ...
                        <p class="text-gray-600">Check your HTML results, marks, and additional details...</p>
                    </div>
                </div>
            </a>
            ...
            <!-- CSS Progress -->
            <a href="course/course/course/CssPrograss">
                <div style="position: absolute ; left: 60vw; top: 40vh" class="flex items-center space-x-4 mt-8">
                    ...
                    <div>
                        ...
                        <p class="text-gray-600">Check your CSS results, marks, and additional details...</p>
                    </div>
                </div>
            </a>

            <!-- JavaScript Progress -->
            <a href="course/course/JSPrograss">
                <div style="position: absolute ; left: 10vw; top: 70vh" class="flex items-center space-x-4 mt-8">
                    ...
                    <div>
                        ...
                        <p class="text-gray-600">Check your JAVASCRIPT results, marks, and additional details...</p>
                    </div>
                </div>
            </a>
